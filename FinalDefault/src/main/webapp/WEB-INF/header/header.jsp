							...
							<div class="col-xl-2 col-lg-2">
								<div class="logo">
									<a href="javascript:Load_Main()"><img
										src="./assets/img/logo/logo1-2.png" alt=""></a>
								</div>
							</div>
											...
											<ul id="navigation">
												...
												<c:if test="${empty sessionScope.userVo}">
													<li class="button-header margin-left "><a
														href="javascript:Load_RegisterForm()" class="btn">Register</a>
													</li>
													<li class="button-header"><a
														href="javascript:Load_LoginForm()" class="btn">Log In</a></li>
												</c:if>
												<c:if test="${!empty sessionScope.userVo}">
													<li class="button-header margin-left "><a
														href="javascript:Load_MyPage()" class="btn">My Page</a></li>
													<li class="button-header"><a
														href="javascript:LogOut()" class="btn">Log Out</a></li>
												</c:if>
