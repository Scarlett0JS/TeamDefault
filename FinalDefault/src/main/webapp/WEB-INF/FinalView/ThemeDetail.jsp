    ...
    <main>
        <div>
            <div role="main" class="details-container">
                <div class="row justify-content-around pb-100 pl-50 pt-40">
                    <!-- pt-100 pb-30 -->
                    <div class="col-sm-5 pb-50 pl-60 right">
                        <img id="ThemeImg"
                            src="./assets/img/reFinal_ThemeImg/ThemeImg_Concat/${themeVo.theme_filepath }" alt=""
                            class="mb-0 center rounded detail-main-img">
                    </div>
                    <div class="col-sm-5 pl-50 pr-60 pb-50">
                        <div class="pt-6">`
                            <h1 id="theme-name">
                                <img src="${ themeVo.theme_icon }" alt="" class="theme-icon"> ${ themeVo.theme_name }
                            </h1>
                            <p id="theme-by"> ${ themeVo.theme_producer } |
                                <img src="./assets/img/icon/download_icon.png" alt="download_icon"
                                    class="download-icon"> ${ themeVo.theme_installcnt } installs |
                                <img src="./assets/img/icon/heart.png" alt="heart" class="heart"> ${
                                themeVo.theme_likes} likes
                            </p>
                        </div>
                        <div class="btn-group">
                            <button type="button" class="btn-dropdown1 dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">Programming
                            </button>
                        ...
                        <div class="btn-group pl-10">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item dropdown-icon" href="javascript:Load_FontImg('JetBrains Mono')">
                                    JetBrains Mono </a>
                                <a class="dropdown-item dropdown-icon" href="javascript:Load_FontImg('D2coding')">
                                    D2coding </a>
                                <a class="dropdown-item dropdown-icon" href="javascript:Load_FontImg('Noto Sans')"> Noto
                                    Sans </a>
                                <a class="dropdown-item dropdown-icon" href="javascript:Load_FontImg('Consolas')">
                                    Consolas </a>
                                <a class="dropdown-item dropdown-icon" href="javascript:Load_FontImg('Fira code')"> Fira
                                    code </a>
                            </div>
                        </div>
                        <div class="row pt-3">
                                    ...
                                    <p class="">
                                        <a href="${themeVo.theme_url}">
                                            <button type="button" class="btn-install">
                                                Install Theme
                                                <img src="./assets/img/icon/download_icon.png" alt="install_icon"
                                                    class="install-icon">
                                            </button>
                                        </a>
                                    </p>
