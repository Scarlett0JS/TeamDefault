				...
				<div class="row justify-content-around">
					...
					<div class="col-sm-5">
						<div class="mt-8">
							...
							<p id="theme-by">
								${ themeVo.theme_producer } | <img
									src="./assets/img/icon/download_icon.png" alt="download_icon"
									class="download-icon"> ${ themeVo.theme_installcnt }
								installs | <img src="./assets/img/icon/heart.png" alt="heart"
									class="heart"> ${
                                themeVo.theme_likes}
								likes
							</p>
						...
						<div class="btn-group">
							<button type="button" class="btn-dropdown1 dropdown-toggle"
								...
								aria-expanded="false">Programming</button>
							<div class="dropdown-menu">
								<a class="dropdown-item dropdown-icon"
									href="javascript:Load_LanguageImg('Java')"><img
								...
								<a class="dropdown-item dropdown-icon3"
									href="javascript:Load_LanguageImg('HTML')"><img
						...
						<div class="btn-group pl-10">
							<button type="button" class="btn-dropdown2 dropdown-toggle"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false">Fonts</button>
							<div class="dropdown-menu">
								<a class="dropdown-item dropdown-icon"
									href="javascript:Load_FontImg('JetBrains Mono')"> JetBrains
									...
									href="javascript:Load_FontImg('Noto Sans')"> Noto Sans </a> <a
									class="dropdown-item dropdown-icon"
									href="javascript:Load_FontImg('Consolas')"> Consolas </a> <a
									class="dropdown-item dropdown-icon"
									href="javascript:Load_FontImg('Fira code')"> Fira code </a>
							</div>
						</div>
						<div class="row pt-3">
										...
										<a href="${themeVo.theme_url}">
											...
											<button type="button" class="btn-commuview-heart" id="heart">
												<img src="./assets/img/icon/heart.png" width="32px"
													onclick="javascript:updatePostLike()">
											</button>
									</p>
								</div>
							</div>
