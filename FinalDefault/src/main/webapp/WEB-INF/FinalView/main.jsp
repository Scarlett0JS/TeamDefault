            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img class="colorRecomm" src="./assets/img/my_img/colorRecomm.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img class="colorRecomm" src="./assets/img/my_img/imgRecomm.png" alt="">
                            </div>
                        </div>
                    </div>
                        <div class="col-3">
                            <div class="cat-cap-image">
                                ...
                                <form action="${cpath}/ImageSelectFromUser.do" id="fileForm" name="fileForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    </select> <input id="imgSubmit" name="imgSubmit" type="submit" style="display: none">
                                </form>
                                <br>
                                <button class='btn-color-s' id="imgButton" onclick="document.fileForm.userinputImg.click()">Select Image</button>
                                <br>
                ...
                <div class="row">
                    <div class="col-6 center font-white">
                        <div class="my-3 p-3 black-background all-rounded">
                            <h2 class="mb-5 font-35px center font-weight-bold font font-white ">Most
                                Popular Extension</h2>
                            <div>
                                <c:forEach var="allEx" items="${allExList}">
                                    <div class="media text-muted pt-5">
                                        <p>
                                            <a href="${ allEx.ex_url }"><img src="${allEx.ex_filepath}"
                                                    class="icon1"></a>
                                        </p>
                        ...
                        <div class="my-3 p-3 black-background all-rounded">
                            ...
                            <div>
                                <c:forEach var="otherEx" items="${otherExList}">
                                    <div class="media text-muted pt-5">
                                        <p>
                                            <a href="${ otherEx.ex_url }"><img src="${otherEx.ex_filepath}"
                                                    class="icon1"></a>
                                        </p>
                                        <p class="media-body pb-3 mb-0 small lh-125 font-12px px-4">
                                            <strong class="d-block text-gray-dark font-20px">${
